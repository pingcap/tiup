...
tiup-playground scale-out --service tidb --count 2
sleep 5
...
# get name of one tidb instance and scale-in
...
# scale out
tiup-playground scale-out --service tikv-cdc --count 2
sleep 5
...
tiup-playground display | grep -qv "exit"
# scale out
tiup-playground scale-out --service tiproxy --count 1
sleep 5
