...
tools/bin/golangci-lint:
	@# Target: pull in specific version of golangci-lint (v2.1.6)
	curl -sfL https://raw.githubusercontent.com/golangci/golangci-lint/master/install.sh | sh -s -- -b ./tools/bin latest
