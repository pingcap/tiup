...
func newPumpInstance(rt Runtime, params NewProcParams) (proc.Process, error) {
...
func scaleInPumpByOffline(rt Runtime, w io.Writer, inst proc.Process, pid int) (async bool, err error) {
