...
func newDMMasterInstance(rt Runtime, params NewProcParams) (proc.Process, error) {
	waitReady := false
...
func scaleInDMMaster(rt Runtime, w io.Writer, inst proc.Process, pid int) (async bool, err error) {
	if inst == nil {
		return false, nil
	}
