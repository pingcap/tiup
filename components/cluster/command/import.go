...
func newImportCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if err = ansible.ParseAndImportInventory(ansibleDir, ansibleCfgFile, clsMeta, inv, gOpt.SSHTimeout, gOpt.ExecutorType); err != nil {
				return err
			}
			...
			if err = ansible.ImportConfig(clsName, clsMeta, gOpt.SSHTimeout, gOpt.ExecutorType); err != nil {
				return err
			}
